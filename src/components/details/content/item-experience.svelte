<script>
	...
	import Leapfrog from '$components/details/content/experience/leapfrog.svelte'
	import Segmueller from '$components/details/content/experience/segmueller.svelte'
	import Hehnerreus from '$components/details/content/experience/hehnerreus.svelte'
	import Kernpunkt from '$components/details/content/experience/kernpunkt.svelte'
	import src from '$assets/img/experience.jpg'

	export let isActive

	const alt = 'Experience'
	let slider
	let currentSlide = 0
	const components = [Leapfrog, Segmueller, Hehnerreus, Kernpunkt]
		...
		<div class="flex flex-row justify-between bg-white/90 p-2 mb-5 border">
			...
			<nav class="select-none">
				<span
					...
					role="button"
					tabindex="0"
					aria-disabled={isFirstSlideActive}>Prev</span
				>
				...
				<span
					...
					role="button"
					tabindex="0"
					aria-disabled={isLastSlideActive}>Next</span
				>
			</nav>
		</div>
